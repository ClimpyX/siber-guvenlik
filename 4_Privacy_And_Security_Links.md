...
- **Ağ**
  - HTTPS üzerinden DNS nasıl etkinleştirilir: [geekwire](https://geekwire.co.uk/privacy-and-security-focused-dns-resolver)
  - DNS leaking sorunu nasıl çözülür: [DNSLeakTest](https://www.dnsleaktest.com/how-to-fix-a-dns-leak.html) 
  - WebRTC Sızıntılarına Karşı Koruma: [Restore Privacy] (https://restoreprivacy.com/webrtc-leaks)
  - İSS ve DNS gizlilik ipuçları: [bluz71](https://bluz71.github.io/2018/06/20/digital-privacy-tips.html)
  - Tor kullanmaya yeni başlayanlar için rehber: [ProPrivacy](https://proprivacy.com/privacy-service/guides/ultimate-tor-browser-guide)
  - Yeni başlayanlar için I2P kılavuzu: [The Tin Hat](https://thetinhat.com/tutorials/darknets/i2p.html)
  - VPN ve Tor'u birlikte kullanma hakkında: [ProPrivacy](https://proprivacy.com/vpn/guides/using-vpn-tor-together)
  - SSID'nin herkese açık olmasını azaltmak için `__nomap` nasıl kullanılır: [ghacks](https://www.ghacks.net/2014/10/29/add-_nomap-to-your-routers-ssid-to-have-it-ignored-by-google-and-mozilla/)
  - Gelişmiş güvenlik için güncel yönlendirici yapılandırmaları: [RouterSecurity.org](https://routersecurity.org/)
- **İletişim**
  - E-posta savunma, mail clientinizi sıfırdan güvenli bir şekilde yapılandırın: [FSF.org](https://emailselfdefense.fsf.org)
  - Kimlik Avı Saldırılarından Nasıl Kaçınılır: [EFF](https://ssd.eff.org/en/module/how-avoid-phishing-attacks)
  - PGP nasıl kullanılır:  [Windows](https://ssd.eff.org/en/module/how-use-pgp-windows), [MacOS](https://ssd.eff.org/en/module/how-use-pgp-mac-os-x) ve [Linux](https://ssd.eff.org/en/module/how-use-pgp-linux)
  - Daha Güvenli GPG Anahtarları Oluşturmak için Adım Adım Kılavuz: [spin.atomicobject.com](https://spin.atomicobject.com/2013/11/24/secure-gpg-keys-guide/)
  - Bitcoin İşlemlerinde Anonimlik Nasıl Korunur? [coinsutra.com](https://coinsutra.com/anonymous-bitcoin-transactions/)
  - Signal(güvenli mesajlaşma uygulaması) için Yeni Başlayanlar Rehberi: [Freedom of the Press Foundation] (https://freedom.press/news/signal-beginners/)
